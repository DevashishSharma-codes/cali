...
export const svgMacBook = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 160"><rect x="36" y="16" width="184" height="114" rx="8" fill="#18181b" stroke="#52525b" stroke-width="4"/><rect x="44" y="24" width="168" height="96" rx="4" fill="#09090b"/><circle cx="128" cy="20" r="2.5" fill="#71717a"/><path d="M12 136h232a8 8 0 0 1 8 8v4H4v-4a8 8 0 0 1 8-8z" fill="#27272a" stroke="#52525b" stroke-width="3"/><path d="M108 136h40v4h-40z" fill="#71717a"/><rect x="70" y="45" width="116" height="54" rx="6" fill="#181822" stroke="#3b82f6" stroke-width="1.5" stroke-dasharray="4 2"/><circle cx="85" cy="58" r="3" fill="#ef4444"/><circle cx="95" cy="58" r="3" fill="#eab308"/><circle cx="105" cy="58" r="3" fill="#22c55e"/><line x1="85" y1="72" x2="145" y2="72" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/><line x1="85" y1="82" x2="165" y2="82" stroke="#cae39f" stroke-width="2" stroke-linecap="round"/></svg>`;

export const svgIphone = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 130 230"><rect x="10" y="10" width="110" height="210" rx="26" fill="#18181b" stroke="#52525b" stroke-width="4"/><rect x="16" y="16" width="98" height="198" rx="20" fill="#09090b"/><rect x="47" y="22" width="36" height="10" rx="5" fill="#27272a"/><circle cx="73" cy="27" r="2" fill="#71717a"/><rect x="26" y="48" width="78" height="42" rx="8" fill="#181822" stroke="#cae39f" stroke-width="1.5"/><circle cx="38" cy="62" r="4" fill="#cae39f"/><line x1="48" y1="62" x2="90" y2="62" stroke="#f8fafc" stroke-width="2" stroke-linecap="round"/><line x1="38" y1="74" x2="80" y2="74" stroke="#94a3b8" stroke-width="2" stroke-linecap="round"/><rect x="26" y="100" width="78" height="70" rx="8" fill="#1e1b4b" stroke="#818cf8" stroke-width="1.5"/><circle cx="65" cy="130" r="14" fill="#6366f1" fill-opacity="0.3" stroke="#818cf8" stroke-width="2"/><line x1="40" y1="156" x2="90" y2="156" stroke="#c7d2fe" stroke-width="2" stroke-linecap="round"/></svg>`;

export const svgMonitor = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 200"><rect x="16" y="16" width="224" height="136" rx="10" fill="#18181b" stroke="#52525b" stroke-width="4"/><rect x="24" y="24" width="208" height="116" rx="6" fill="#09090b"/><path d="M108 152l-12 36h64l-12-36" fill="#27272a" stroke="#52525b" stroke-width="3"/><rect x="76" y="188" width="104" height="6" rx="3" fill="#52525b"/><rect x="40" y="42" width="176" height="80" rx="6" fill="#0f172a" stroke="#38bdf8" stroke-width="1.5"/><path stroke="#38bdf8" stroke-width="2" stroke-linecap="round" fill="none" d="M60 95l25-25 30 20 40-35 30 25"/><circle cx="155" cy="55" r="4" fill="#f59e0b"/></svg>`;

export const svgTablet = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 170 230"><rect x="12" y="10" width="146" height="210" rx="18" fill="#18181b" stroke="#52525b" stroke-width="4"/><rect x="18" y="16" width="134" height="198" rx="12" fill="#09090b"/><circle cx="85" cy="14" r="2.5" fill="#71717a"/><rect x="30" y="36" width="110" height="70" rx="8" fill="#1a1c2e" stroke="#c084fc" stroke-width="1.5"/><line x1="42" y1="56" x2="110" y2="56" stroke="#c084fc" stroke-width="2.5" stroke-linecap="round"/><line x1="42" y1="72" x2="126" y2="72" stroke="#e9d5ff" stroke-width="2" stroke-linecap="round"/><line x1="42" y1="88" x2="95" y2="88" stroke="#a855f7" stroke-width="2" stroke-linecap="round"/></svg>`;

export const svgServerRack = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 190 250"><rect x="16" y="14" width="158" height="222" rx="14" fill="#18181b" stroke="#3f3f46" stroke-width="4"/><rect x="26" y="24" width="138" height="42" rx="6" fill="#22222a" stroke="#52525b" stroke-width="2"/><rect x="26" y="74" width="138" height="42" rx="6" fill="#22222a" stroke="#52525b" stroke-width="2"/><rect x="26" y="124" width="138" height="42" rx="6" fill="#22222a" stroke="#52525b" stroke-width="2"/><rect x="26" y="174" width="138" height="42" rx="6" fill="#22222a" stroke="#52525b" stroke-width="2"/><circle cx="42" cy="45" r="4.5" fill="#22c55e"/><circle cx="56" cy="45" r="4.5" fill="#3b82f6"/><circle cx="70" cy="45" r="4.5" fill="#cae39f"/><line x1="94" y1="45" x2="148" y2="45" stroke="#71717a" stroke-width="4" stroke-linecap="round"/><circle cx="42" cy="95" r="4.5" fill="#22c55e"/><circle cx="56" cy="95" r="4.5" fill="#3b82f6"/><circle cx="70" cy="95" r="4.5" fill="#eab308"/><line x1="94" y1="95" x2="148" y2="95" stroke="#71717a" stroke-width="4" stroke-linecap="round"/><circle cx="42" cy="145" r="4.5" fill="#22c55e"/><circle cx="56" cy="145" r="4.5" fill="#3b82f6"/><circle cx="70" cy="145" r="4.5" fill="#22c55e"/><line x1="94" y1="145" x2="148" y2="145" stroke="#71717a" stroke-width="4" stroke-linecap="round"/><circle cx="42" cy="195" r="4.5" fill="#22c55e"/><circle cx="56" cy="195" r="4.5" fill="#a855f7"/><circle cx="70" cy="195" r="4.5" fill="#3b82f6"/><line x1="94" y1="195" x2="148" y2="195" stroke="#71717a" stroke-width="4" stroke-linecap="round"/></svg>`;

export const svgBladeServer = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 110"><rect x="16" y="16" width="224" height="78" rx="10" fill="#18181b" stroke="#52525b" stroke-width="4"/><rect x="28" y="28" width="110" height="54" rx="6" fill="#27272a" stroke="#3f3f46" stroke-width="2"/><line x1="42" y1="42" x2="124" y2="42" stroke="#52525b" stroke-width="3" stroke-linecap="round"/><line x1="42" y1="55" x2="124" y2="55" stroke="#52525b" stroke-width="3" stroke-linecap="round"/><line x1="42" y1="68" x2="124" y2="68" stroke="#52525b" stroke-width="3" stroke-linecap="round"/><circle cx="160" cy="55" r="7" fill="#22c55e"/><circle cx="182" cy="55" r="7" fill="#3b82f6"/><circle cx="204" cy="55" r="7" fill="#cae39f"/><rect x="220" y="38" width="10" height="34" rx="2" fill="#3f3f46"/></svg>`;

export const svgIotDevice = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 160"><rect x="24" y="24" width="112" height="112" rx="22" fill="#18181b" stroke="#3f3f46" stroke-width="4"/><circle cx="80" cy="80" r="28" fill="#22c55e" fill-opacity="0.2" stroke="#22c55e" stroke-width="3"/><circle cx="80" cy="80" r="10" fill="#22c55e"/><path stroke="#38bdf8" stroke-width="3" stroke-linecap="round" fill="none" d="M80 34a46 46 0 0 1 46 46m-92 0a46 46 0 0 1 46-46"/><path stroke="#a855f7" stroke-width="2.5" stroke-linecap="round" fill="none" d="M80 20a60 60 0 0 1 60 60m-120 0a60 60 0 0 1 60-60"/></svg>`;
